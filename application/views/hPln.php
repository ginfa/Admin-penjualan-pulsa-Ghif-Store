            ...
            <div class="header-text">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h3 class="light white"><font style="color: #ffddaa">TOKEN PLN</font></h3>
                        <h1 class="white typed"><font style="color: #ffddaa">TOKEN</font></h1>
...
<div class="box">
    <div class="box-header" >
        <h3 class="box-title"><center>GHIF STORE</center></h3>
    </div>
    <!-- /.box-header -->
    <div class="box">
        <div class="col-md-13">
