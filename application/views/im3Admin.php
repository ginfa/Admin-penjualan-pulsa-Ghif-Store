        ...
        <section class="content">
            <div class="box">
                <div class="box-header with-border">
                    <center><h3 class="box-title"> DATA IM3</h3></center>
            ...
            <div class="box">
                <div class="col-md-13">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">DATA IM3</h3>
                        </div>
                                ...
                                <table id="example1" class="table table-bordered table-striped data">
                                    ...
                                    foreach ($tampilIm3->result() as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <center>
                                                    <a class="btn btn-info" href="<?php echo base_url() ?>Kuota/editkuota/<?php echo $value->id ?>" >Edit</a>
