...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="<?php echo base_url()?>manager/frm_manager" class="logo">
            ...
            <span class="logo-mini"><b>Ghif</b>store</span>
        ...
        <section class="content">
            <div class="box">
                <div class="box-header with-border">
                    <center><h3 class="box-title"> DATA TELKOMSEL</h3></center>
            ...
            <div class="box">
                <div class="col-md-13">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">DATA TELKOMSEL</h3>
                        </div>
                            ...
                            <div class="box-body">
                                ...
                                <table id="example1" class="table table-bordered table-striped data">
                                    ...
                                    foreach ($tampilTsl->result() as $value) {
                                        ?>
                                        <tr>
                                            <td><center><strong><font style="color: #000000"><?php echo $value->isi; ?></font></strong></center></td>
                                            <td><center><strong><font style="color: #000000"><?php echo $value->waktu; ?></font></strong></center></td>
                                            <td><center><strong><font style="color: #000000"><?php echo $value->harga; ?></font></strong></center></td>
                                            <td><center><strong><font style="color: #000000"><?php if($value->status == 'close') { ?>
                                            ...
                                            <th>
                                                <center>
                                                <a class="btn btn-info" href="<?php echo base_url() ?>Kuota1/editkuota/<?php echo $value->id ?>" >Edit</a>

                                                <a class="btn btn-danger" href="<?php echo base_url() ?>Kuota1/hapus/<?php echo $value->id ?>" >Hapus</a>
                                                </center>
                                            </th>
                                        </tr>
                                        <?php $id++;  } ?>
