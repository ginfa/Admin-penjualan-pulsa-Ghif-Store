...
foreach ($tampilbyid->result() as $value) {
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box">
                    <form class="form-horizontal" action="<?php echo base_url()?>Kuota/editm3" method="post">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <select id="rencana_pembayaran_per" name="kuota_edit" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="inputEmail3"
                                           name="isi_edit" placeholder="isi" required="true" value="<?php echo $value->isi ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-3 control-label">Waktu</label>
                                <div class="col-sm-6">
                                    <select id="rencana_pembayaran_per" name="waktu_edit" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="harga"
                                           name="harga_edit" placeholder="harga" required="true" value="<?php echo $value->harga ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-3 control-label">Status</label>
                                <div class="col-sm-6">
                                    <select id="rencana_pembayaran_per" name="status_edit" class="form-control">
