...
foreach ($tampilid->result() as $value) {
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box">
                    <form class="form-horizontal" action="<?php echo base_url()?>Kuota1/edit" method="post" ">
                        <div class="box-body">
