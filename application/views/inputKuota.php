                ...
                <div class="box">
                    <div class="box-body">
                        <div class="box-header with-border">
                            <center><h3 class="box-title">Pencatatan Kuota</h3></center>
                    ...
                    <div class="box">
                        <form class="form-horizontal" action="<?php echo base_url()?>Kuota/tambahKuota" method="post" onsubmit="return required();">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select id="rencana_pembayaran_per" name="kuota" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select id="rencana_pembayaran_per" name="waktu" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="harga"
                                               name="harga" placeholder="harga" required="true">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-3 control-label">Status</label>
                                    <div class="col-sm-6">
                                        <select id="rencana_pembayaran_per" name="status" class="form-control">
